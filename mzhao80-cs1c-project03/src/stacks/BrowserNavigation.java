 ...
 *
 * @author Foothill College, Bita M, Michael Zhao
 */
public class BrowserNavigation
{
	...
	/**
	 * Navigator used by browser to go through links.
	 */
	 ...
	 * @return True if link has been seen, False if it has not.
	 */
	...
	public static void main(String[] args) 
	{
		...
		// final String FILENAME = "resources/inputFile01.txt";
		// final String FILENAME = "resources/inputFile02.txt";
