...
public class LazySearchTree<E extends Comparable<? super E>> implements Cloneable {
    ...
    /**
     * Hard removes all lazily deleted nodes
     *
    ...
    /**
     * Hard removes a single node.
     *
     * @param root Node acting as current working root
     * @param x    Item to be removed.
     * @return Node that was hard removed.
     */
    ...
    protected LazySTNode findMin(LazySTNode root) {
        ...
        LazySTNode potentialMin = findMin(root.lftChild);
        ...
        potentialMin = findMin(root.rtChild);
        return potentialMin;
    }

    /**
     * Finds the true maximum node.
     *
     * @param root Node to act as working root
    ...
    protected LazySTNode findMinHard(LazySTNode root) {
        ...
        LazySTNode potentialMin = findMinHard(root.lftChild);
        if (potentialMin != null) {
            return potentialMin;
        }
        return root;
    ...
    protected LazySTNode findMax(LazySTNode root) {
        ...
        LazySTNode potentialMax = findMax(root.rtChild);
        ...
        potentialMax = findMax(root.lftChild);
        return potentialMax;
    }
    ...
    protected LazySTNode findMaxHard(LazySTNode root) {
        ...
        LazySTNode potentialMax = findMaxHard(root.rtChild);
        if (potentialMax != null) {
            return potentialMax;
        }
        return root;
    ...
    protected LazySTNode insert(LazySTNode root, E x) {
        ...
        if (root == null) {
            mSize++;
            mSizeHard++;
            root = new LazySTNode(x, null, null);
            return root;
        }
