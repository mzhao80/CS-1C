...
{
	/**
	 * List of prices for all groceries.
	 */
	...
	{
		// Define the class GroceriesFileReader
		GroceriesFileReader reader = new GroceriesFileReader();

		// Define the readFile() method which reads the CSV (Comma Separated Value) file
	...
	public static void main(String[] args)
	{
		...
		//final String FILEPATH = "resources/inputFile01.txt";
