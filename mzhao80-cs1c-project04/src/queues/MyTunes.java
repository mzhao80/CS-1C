 ...
 *  
 * @author Foothill College, Michael Zhao
 */
public class MyTunes 
{
	...
	// Define the class Jukebox such that it manages three objects of type Queue<SongEntry>
	...
	public static void main(String[] args) 
	{
		...
		//final String TESTFILE = "resources/inputFile01.txt";
		//final String TESTFILE = "resources/inputFile02.txt";
