...
public class MyTunes 
{
	...
	public static void main(String[] args) 
	{
		...
		//final String TESTFILE01 = "resources/newIDs.txt";	// Example test file for hashing based on IDs
		//final String TESTFILE02 = "resources/newGenres.txt"; // Example test file for hashing based on genres names
